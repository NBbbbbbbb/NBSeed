      ...
      <div class="title clearfix">
        ...
        <div class="fr">
          <ul class="nav-tabs clearfix">
            <li v-for="item,index in floor.navList" :key="index + '21'">
      ...
      floor: [
        {
          ...
          carouselList: [
            {
              id: "0011",
              imgUrl: "/img/floor-1-b01.png"
            },
            {
              id: "0012",
              imgUrl: "/img/floor-1-b02.png"
            },
            {
              id: "0013",
              imgUrl: "/img/floor-1-b03.png"
            }
          ],
          recommendList: [
            "/img/floor-1-2.png",
